...
using TaskStatuses = MvcTaskManager.Models.TaskStatus;
...
namespace MvcTaskManager.Identity
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<MvcTaskManager.Models.Project> Projects { get; set; }
        public DbSet<Country> Countries { get; set; }
        public DbSet<Skill> Skills { get; set; }
        public DbSet<TaskPriority> TaskPriorities { get; set; }
        public DbSet<MvcTaskManager.Models.TaskStatus> TaskStatuses { get; set; }
        public DbSet<MvcTaskManager.Models.Task> Tasks { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MvcTaskManager.Models.Project>().HasData(
                new MvcTaskManager.Models.Project() { ProjectID = 1, ProjectName = "Hospital Management System", DateOfStart = Convert.ToDateTime("2017-8-1"), Active = true, ClientLocationID = 2, Status = "In Force", TeamSize = 14 },
                new MvcTaskManager.Models.Project() { ProjectID = 2, ProjectName = "Reporting Tool", DateOfStart = Convert.ToDateTime("2018-3-16"), Active = true, ClientLocationID = 1, Status = "Support", TeamSize = 81 }
            );
            ...
            modelBuilder.Entity<TaskStatuses>().HasData(
                new TaskStatuses() { TaskStatusID = 1, TaskStatusName = "Holding" },
                new TaskStatuses() { TaskStatusID = 2, TaskStatusName = "Prioritized" },
                new TaskStatuses() { TaskStatusID = 3, TaskStatusName = "Started" },
                new TaskStatuses() { TaskStatusID = 4, TaskStatusName = "Finished" },
                new TaskStatuses() { TaskStatusID = 5, TaskStatusName = "Reverted" }
                );
        }
    }
}
