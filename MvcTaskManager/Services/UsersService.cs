...
namespace MvcTaskManager.Services
{
    public class UsersService : IUsersService
    {
        ...
        public UsersService(UserManager<ApplicationUser> applicationUserManager, SignInManager<ApplicationUser> applicationSignInManager, IOptions<AppSettings> appSettings, ApplicationDbContext db)
        {
